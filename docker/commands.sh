...
sudo ceph pg ls-by-pool default.rgw.buckets.data | python ~/cephcluster/docker/tools/info.py
sudo ceph orch ps 
sudo ceph device ls
...
sudo ceph pg ls-by-pool default.rgw.buckets.data | python docker/tools/info.py
